...
<div class="header">
 ...
 <form action="search.php" method="GET">
  ...
  <div class="container">
    <a href='/tourismcat/transport.php' class="add btn btn-primary">New Add</a>
    
    <div class="text-center">

      <center><h2 class="list">LIST OF TRANSPORT TABLES IN DATABASE</h2></center>
      <table class="table">
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>{$row['email']}</td>
                <td>{$row['telephone']}</td>
                <td>{$row['companiesName']}</td> 
                <td>{$row['time_arrival']}</td>
                <td>{$row['tourist_residental']}</td>
                <td>{$row['createAt']}</td>
                <td>
                  <a href='/tourismcat/edit.php?id={$row['id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/tourismcat/transportdelete.php?id={$row['id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }

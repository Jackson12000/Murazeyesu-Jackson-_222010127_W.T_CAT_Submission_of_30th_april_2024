...
<div class="header">
 ...
 <form action="search.php" method="GET">
  ...
  <div class="container">
    <a href='/tourismcat/accommodation.php' class="add btn btn-primary">New Add</a>
    
    <div class="text-center">

      <center><h2 class="list">LIST OF Accommodation TABLE IN DATABASE</h2></center>
      <table class="table">
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>{$row['createAt']}</td> 
                <td>
                  <a href='/tourismcat/accoedit.php?id={$row['id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/tourismcat/accodelete.php?id={$row['id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }

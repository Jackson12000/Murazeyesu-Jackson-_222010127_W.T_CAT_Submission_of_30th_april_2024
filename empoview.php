...
<div class="header">
 ...
 <form action="search.php" method="GET">
  ...
  <div class="container">
    <a href='/tourismcat/employees.php' class="add btn btn-primary">New Add</a>
    
    <div class="text-center">

      <center><h2 class="list">LIST OF EMPLOYEES TABLES IN DATABASE</h2></center>
      <table class="table">
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>{$row['position']}</td> 
                <td>
                  <a href='/tourismcat/empoedit.php?id={$row['id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/tourismcat/empodelete.php?id={$row['id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }

...
<div class="header">
 ...
 <form action="search.php" method="GET">
  ...
  <div class="container">
    <a href='/tourismcat/tourist.php' class="add btn btn-primary">New Add</a>
    <a class="log" href="/tourismcat/index.php" class="logout-link">LOGOUT</a>
    <div class="text-center">

      <center><h2 class="list">LIST OF TOURIST TABLES IN DATABASE</h2></center>
      <table class="table">
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>{$row['createAt']}</td>
                <td>
                  <a href='/tourismcat/touristedit.php?id={$row['id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/tourismcat/touristdelete.php?id={$row['id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }

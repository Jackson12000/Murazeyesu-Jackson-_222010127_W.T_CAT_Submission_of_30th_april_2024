...
<div class="header">
 ...
 <form action="search.php" method="GET">
  ...
  <div class="container">
    <a href='/tourismcat/payment.php' class="add btn btn-primary">New Add</a>
   
    <div class="text-center">

      <center><h2 class="list">LIST OF PAYMENT TABLES IN DATABASE</h2></center>
      <table class="table">
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>{$row['firstname']}</td> 
                <td>{$row['lastname']}</td>
                <td>{$row['payeesname']}</td>
                <td>{$row['amount']}</td>
                <td>{$row['payment_date']}</td>
                <td>{$row['payment_method']}</td> 
                <td>{$row['createAt']}</td>
                <td>
                  <a href='/tourismcat/paymentedit.php?id={$row['id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/tourismcat/paymentdelete.php?id={$row['id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }

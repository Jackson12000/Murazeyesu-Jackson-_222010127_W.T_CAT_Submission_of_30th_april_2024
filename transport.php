...
<center>
<div class="container">
    <form class="ff" action="transiadd.php" method="POST" onsubmit=" return confirmInsert();">
        <table>
            <tr>
                <td colspan="2">
                    <h2 class="lo">Transport Form</h2>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input class="in" type="text" name="email" placeholder="Please enter your email"></td>
            </tr>
            <tr>
                <td class="lo">telephone</td>
                <td><input class="in" type="text" name="telephone" placeholder="Please enter your telephone" ></td>
            </tr>
           
            <tr>
                <td class="lo">CompaniesName</td>
                <td>
                    <select class="in" name="company" required>
                ...
                <tr>
                <td class="lo">time_arrival</td>
                <td><input class="in" type="date" name="arrival" id="arrival" ></td>
            </tr>
            </tr>
            <tr>
                <td class="lo">Tourist_Residental</td>
                <td>
